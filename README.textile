...
* *holder*: The div that contains the rating widget, either as an id (string) or as a prototype extended element ($(id)). Must be provided.
* *url*: The url to submit the rating to via Ajax. Must be provided.
